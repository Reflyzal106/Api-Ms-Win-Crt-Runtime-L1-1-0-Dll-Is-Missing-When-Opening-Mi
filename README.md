# [SOLVED] Api-Ms-Win-Crt-Runtime-L1-1-0-Dll-Is-Missing-When-Opening-Mi
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/api-ms-win-crt-runtime-l1-1-0-dll-is-missing-when-opening-mi)
>
...
Try reinstalling Microsoft Office or running the Office Repair tool to fix the issue.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/api-ms-win-crt-runtime-l1-1-0-dll-is-missing-when-opening-mi)**
